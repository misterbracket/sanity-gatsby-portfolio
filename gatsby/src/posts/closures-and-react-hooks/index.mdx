...
Closures are a fundamental part of JavaScript. Still, t took me a while to wrap my head around them. I knew kind of what they are and why they are helpful, but I never really "got it”. In this blog post, I will try to dissect this topic and explain Closures step by step by first introducing the concept of open and closed expressions. Finally, I will discuss some use cases and why closures are essential for the web.
...
The first time I heard this definition, I did not understand what it meant. It only clicked
for me once I understood the concept of **open** and **closed expressions**.
...
One intersting thing about function expressions is that they can be called right away like this:
